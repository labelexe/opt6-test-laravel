...
<div class="heading_wrapper d-flex align-items-center justify-content-between">
    <div class="heading_content">
        <div class="content_title">
            <h5>{{ $page_title }} - {{ $data['company']['item']['name'] }}</h3>
        </div>
    </div>
    ...
    <div class="company">
        <div class="company_wrapper">
            ...
            <div class="company_form">
                <form method="POST" action="{{route('company.update', $data['company']['item']['id'])}}" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="company_form_list">
                            <div class="company_from_item mb-3">
                                <div class="form-group">
                                    ...
                                    <label for="fileLogoCompany" class="m-2">Выбор нового логотипа компании</label>
                            ...
                            <div class="company_from_item mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="nameCompany" name="name" class="form-control" placeholder="Введите название-компании" value="{{ $data['company']['item']['name'] ? $data['company']['item']['name'] : $data['company']['item']['name'] }}">
                            ...
                            <div class="company_from_item mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="email" id="emailCompany" name="email" class="form-control" placeholder="Введите email-компании" value="{{ $data['company']['item']['email'] ? $data['company']['item']['email'] : ''}}">
                                </div>
                            </div>
                            ...
                            <div class="company_from_item mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="addressCompany" name="address" class="form-control" placeholder="Введите адрес-компании" value="{{ $data['company']['item']['address'] ? $data['company']['item']['address'] : '' }}">
                                </div>
                            </div>
